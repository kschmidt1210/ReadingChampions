...
import { Trophy, BookOpen, Settings, Plus, LogOut, Sparkles, Scale, UserCog, MessageSquare } from "lucide-react";
...
const navItems = [
  ...
  { href: "/community", label: "Community", icon: MessageSquare, color: "text-fuchsia-500" },
